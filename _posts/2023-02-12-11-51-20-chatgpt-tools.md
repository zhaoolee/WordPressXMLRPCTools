...
![万能的神ChatGPT](./2023-02-12-11-51-20-chatgpt-tools.assets/1676174451000KeDpwQpp.png)
...
![Github Copilot](./2023-02-12-11-51-20-chatgpt-tools.assets/1676388165450nM61PXep.png)
...
![ChatGPT会员可选两个模型](./2023-02-12-11-51-20-chatgpt-tools.assets/16763881124562hMXBxj0.png)
...
![ChatGPT生成代码错误](./2023-02-12-11-51-20-chatgpt-tools.assets/1676388146463BdwKih68.png)
...
![ChatGPT写样式](./2023-02-12-11-51-20-chatgpt-tools.assets/1676388157468sfYzJBzz.png)

![ChatGPT改写代码](./2023-02-12-11-51-20-chatgpt-tools.assets/1676388151551siTXYhfj.png)
...
![继续输出](./2023-02-12-11-51-20-chatgpt-tools.assets/1676791642645W1cwE1sM.png)

![内容输出](./2023-02-12-11-51-20-chatgpt-tools.assets/1676792079400DdntR7yk.png)

然而，ChatGPT 还是漏了package.json的输出，我们可以要求ChatGPT对package.json内容重新输出

![image-20230219152951399](./2023-02-12-11-51-20-chatgpt-tools.assets/1676791795522fBdCRTkh.png)

前面我们明确要求了ChatGPT进行函数式编程，如果我们需要优化某个函数的输出，可以直接让ChatGPT继续修改

![继续修改](./2023-02-12-11-51-20-chatgpt-tools.assets/1676792402391k6dyT3Gt.png)

## 运行ChatGPT修改后的脚本

![运行结果](./2023-02-12-11-51-20-chatgpt-tools.assets/1676792910598Mdb2YHK7.png)
...
![WordPress主题推荐](./2023-02-12-11-51-20-chatgpt-tools.assets/16767926636634Km8wCF5.png)
...
![凯恩斯陷阱](./2023-02-12-11-51-20-chatgpt-tools.assets/1676794239411debrfTzc.png)
